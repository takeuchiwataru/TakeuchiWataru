...
#define TITLE_SIZE_X      (550)									// テクスチャを張り付ける幅
#define TITLE_SIZE_Y      (200)									// テクスチャを張り付ける高さ
#define TEXTURE_SIZE_X      (500)								// テクスチャを張り付ける幅
#define TEXTURE_SIZE_Y      (100)								// テクスチャを張り付ける高さ
