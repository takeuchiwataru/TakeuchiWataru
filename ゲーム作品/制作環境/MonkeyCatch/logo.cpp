...
HRESULT CResultLogo::Load(void)
{
	...
	//D3DXCreateTextureFromFile(pDevice, RESULTLOGO_TEXTURE001, &m_apTexture[1]);
...
HRESULT CPressEnter::Init(D3DXVECTOR3 pos, PRESSENTER type)
{
	...
	{// タイトル
		CLogo::SetPosition(pos, PRESSENTER_SIZE_X, PRESSENTER_SIZE_Y);
	}
	else if(m_nType == PRESSENTER_TUTORIAL)
	{// チュートリアル
		CLogo::SetPosition(pos, 170, PRESSENTER_SIZE_Y);
	}
