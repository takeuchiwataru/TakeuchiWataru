...
void CGame::Init(void)
{
	...
	{// メッシュフィールドの生成
		...
		m_pMeshField->LoadMeshFiled();
		m_pMeshField->Nor();
	}

	if (m_pEnemy == NULL)
	{// 敵の配置情報の読み込み
		m_pEnemy->LoadSetEnemy();
	}
	...
	if (m_pGrass == NULL)
	{// 草の配置情報の読み込み
		m_pGrass->LoadSetGrass();
	}

	//// 草の生成
	//CGrass::Create(D3DXVECTOR3(300.0f, 0.0f, -300.0f),CGrass::GRASSTYPE_001);
	//CGrass::Create(D3DXVECTOR3(1150.0f, 95.0f, -1200.0f), CGrass::GRASSTYPE_001);
	...
	//CGrass::Create(D3DXVECTOR3(1200.0f, 0.0f, -650.0f), CGrass::GRASSTYPE_000);
	////CGrass::Create(D3DXVECTOR3(350.0f, 95.0f, -630.0f), CGrass::GRASSTYPE_000);
	//CGrass::Create(D3DXVECTOR3(650.0f, 80.0f, -730.0f), CGrass::GRASSTYPE_000);
	...
	//CGrass::Create(D3DXVECTOR3(350.0f, 70.0f, -1100.0f), CGrass::GRASSTYPE_000);
...
void CGame::Uninit(void)
{
	...
	if (m_pEnemy != NULL)
	{// 敵がNULLじゃなかったらNULLにする
		m_pEnemy = NULL;
	}
	
	if (m_pGrass != NULL)
	{// 草がNULLじゃなかったらNULLにする
		m_pGrass = NULL;
	}
	if (m_pMeshField != NULL)
