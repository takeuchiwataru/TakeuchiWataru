...
// 敵の配置
#define SETENEMY_FILE ("data/TEXT/setenemy.txt")
#define SCRIPT "SCRIPT"
#define MAX_ENEMY "MAX_ENEMY = "
#define TEXT_FILENAME "TEXT_FILENAME = "
#define ENEMYSET "ENEMYSET"
#define END_ENEMYSET "END_ENEMYSET"
#define TYPE "TYPE = "
...
public:
	...
	static CShadowX * m_pShadow;
	static CCircle * m_pCircle;
