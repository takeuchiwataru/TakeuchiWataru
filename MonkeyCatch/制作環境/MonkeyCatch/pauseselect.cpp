...
HRESULT CPauseSelect::Init(D3DXVECTOR3 pos)
{
	for (int nCntPauseSelect = 0; nCntPauseSelect < MAX_PAUSE_SELECT; nCntPauseSelect++)
	{
		...
		//if (m_nType == RESTART_CONTINUE)
		//{// CONTINUE
		//	m_apLogo[nCntPauseSelect]->BindTexture(CTexture::GetTexture(11));
		//}
		//if (m_nType == RESTART_RETRY)
		//{// RETRY
		//	m_apLogo[nCntPauseSelect]->BindTexture(CTexture::GetTexture(12));
		//}
		//if (m_nType == RESTART_QUIT)
		//{// QUIT
		//	m_apLogo[nCntPauseSelect]->BindTexture(CTexture::GetTexture(13));
		//}
