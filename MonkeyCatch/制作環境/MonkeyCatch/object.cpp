...
//LPD3DXMESH CObject::m_apMesh[OBJECTTYPE_MAX] = {};
//LPD3DXBUFFER CObject::m_apBuffMat[OBJECTTYPE_MAX] = {};
//DWORD CObject::m_nNumMat[OBJECTTYPE_MAX] = {};
//
//=============================================================================
// コンストラクタ
//=============================================================================
CObject::CObject() :CSceneX(3)
{
...
HRESULT CObject::Init(D3DXVECTOR3 pos, D3DXVECTOR3 rot, OBJECTTYPE type)
{
	...
	//CSceneX::BindModelTex(m_pTexture, m_apMesh[m_type], m_apBuffMat[m_type], m_nNumMat[m_type]);
	CSceneX::Init(pos);
...
HRESULT CObject::LoadX(void)
{
	...
	// Xファイルの読み込み
	D3DXLoadMeshFromX(OBJECT_MODEL_NAME000, D3DXMESH_SYSTEMMEM, pDevice, NULL, &m_pBuffMat, NULL, &m_nNumMat, &m_pMesh);
	...
	//{
		...
		//m_pTexture = new LPDIRECT3DTEXTURE9[m_nNumMat[nCntModel]];
