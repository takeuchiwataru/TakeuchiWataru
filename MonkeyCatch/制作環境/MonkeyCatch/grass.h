...
// 敵の配置
#define SETGRASS_FILE ("data/TEXT/setgrass.txt")
#define SCRIPT "SCRIPT"
#define MAX_GRASS "MAX_GRASS = "
#define TEXT_FILENAME "TEXT_FILENAME = "
#define GRASSSET "GRASSSET"
#define END_GRASSSET "END_GRASSSET"
#define TYPE "TYPE = "
...
public:
	...
	D3DXVECTOR3 GetPos(D3DXVECTOR3 *pPos);

	void LoadSetGrass(void);
...
private:
	...
	//D3DXVECTOR3 m_aPos[10];						// テキストに書かれている位置情報保管
	//GRASSTYPE m_aType[10];						// テキストに書かれている種類情報保管
	...
	char m_aFilenameModel[MAX_GRASS_MODEL][MAX_CHAR];
